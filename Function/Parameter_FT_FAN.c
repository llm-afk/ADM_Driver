...
#define  MAX_PEAK_CUR_3_3V             5000        //! 0.01A // 电流采集的最大量程，由运放增益和采样电阻阻值共同决定 ±20A就填2000
...
unsigned int MOTOR_RATED_CUR    =  500; //! 20A的额定电流，这里是额定
...
// 电流环环参数设置
///////////////////////////////////////////////////////////////////////////////////////
unsigned int D_CUR_KI               =  210; // !
unsigned int D_CUR_KP               =  0;  // !
unsigned int Q_CUR_KI               =  210; // !
