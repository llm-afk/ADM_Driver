...
// 控制板参数设置
///////////////////////////////////////////////////////////////////////////////////////
unsigned int MAX_DC_VOL_3_3V        =  630;        //! 0.1vdc 母线电压采集的最大量程 根据实际的硬件电路决定3V和16倍
...
unsigned int MOTOR_RATED_VOL    =  21;  //! 相电压的有效值，输入实际的母线电压/1.414
...
// 电流环环参数设置
///////////////////////////////////////////////////////////////////////////////////////
unsigned int D_CUR_KI               =  1400; // !
unsigned int D_CUR_KP               =  1400;  // !
unsigned int Q_CUR_KI               =  1400; // !
unsigned int Q_CUR_KP               =  1400;  // !
