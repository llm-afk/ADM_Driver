...
#define  MAX_PEAK_CUR_3_3V             1875        //! 0.01A // 电流采集的最大量程，由运放增益和采样电阻阻值共同决定 ±20A就填2000 
...
#define HARDWARE_OVER_CUR            1500 //! 硬件比较器的过流阈值，根据硬件设计决定
...
unsigned int MOTOR_RATED_VOL    =  17;  //! 额定电压 母线电压/sqrt2
unsigned int MOTOR_RATED_CUR    =  120; //! 20A的额定电流，这里是额定
...
// 电流环环参数设置
///////////////////////////////////////////////////////////////////////////////////////
unsigned int D_CUR_KI               =  30; // !
unsigned int D_CUR_KP               =  30; // !
unsigned int Q_CUR_KI               =  30; // !
unsigned int Q_CUR_KP               =  30; // !
